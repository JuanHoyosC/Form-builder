import { ChangeDetectorRef, Component, inject, Input, NO_ERRORS_SCHEMA } from '@angular/core';
...
export class FormFieldGroupItemComponent {
  ...
  openMenuForSelectedField(event: MouseEvent) {
    ...
    this.formBuilderTypesService.openMenuForSelectedField(this.field);
  }

  closeMenuForSelectedField() {
    this.formBuilderTypesService.closeMenuForSelectedField();
  }
